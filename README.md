...
Title of Dataset: __SAFI_openrefine.csv__
...
data obtained from interviews of farmers in two countries in eastern sub-Saharan Africa (Mozambique and Tanzania)

[link to dataset](http://datacarpentry.org/openrefine-socialsci/02-working-with-openrefine/index.html)
